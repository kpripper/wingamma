...
Значення зберігаються після кожної зміни. Кнопка
`Зберегти + автозапуск` додатково вмикає WinGamma loader у профілі поточного
користувача, щоб активний HSL-оверлей відновлювався після входу у Windows, сну,
розблокування та зміни режиму дисплея. Чекбокс HSL має бути увімкнений.
